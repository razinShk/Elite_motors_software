    ...
    <div className="h-screen bg-black text-white overflow-y-scroll snap-y snap-mandatory overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black/80 backdrop-blur-md' : ''}`}>
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          <div className="text-xl font-medium">Elite Car Detailing</div>

          <div className="hidden md:flex items-center gap-8">
            <a href="#services" className="text-white/80 hover:text-white transition-colors">Services</a>
            <a href="#cars" className="text-white/80 hover:text-white transition-colors">Cars</a>
            <a href="#about" className="text-white/80 hover:text-white transition-colors">About</a>
            <a href="#contact" className="text-white/80 hover:text-white transition-colors">Contact</a>
          </div>

          <button className="border border-white rounded-lg px-6 py-3 hover:bg-white hover:text-black transition-all">
            Get a quote
          </button>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <section className="relative h-screen snap-start flex items-center justify-center pt-24">
        {/* Background */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <button className="inline-flex items-center gap-2 text-white group-hover:gap-4 transition-all">
                  Learn more
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <a href="#" className="inline-flex items-center gap-2 text-white mt-8 ml-10 hover:gap-4 transition-all">
                  Get a quote now
                  <ArrowRight className="w-4 h-4" />
                </a>
              </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <a href="#" className="inline-flex items-center gap-2 text-white text-lg hover:gap-4 transition-all">
                Get a quote now
          ...
          >
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#contact" className="text-gray-400 hover:text-gray-300 transition-colors">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-white hover:text-gray-300 transition-colors">Get a quote</a></li>
                <li><a href="#" className="text-white hover:text-gray-300 transition-colors">Contact form</a></li>
