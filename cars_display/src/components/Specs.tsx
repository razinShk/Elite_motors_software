...
export default function Specs() {
  const specs = [
    ...
    { label: "Power", value: "707 bhp" }, // Updated to Hellcat specs roughly
    { label: "Weight", value: "4449 lbs" },
    { label: "Top Speed", value: "199 mph" },
  ];

  return (
    <div className="grid grid-cols-2 gap-8 md:flex md:flex-col md:gap-0 md:space-y-16 pr-0 md:pr-12 w-full h-full px-6 md:px-0">
