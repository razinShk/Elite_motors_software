...
export type Sale = Tables<'elite_sales'>;
export type SaleItem = Tables<'elite_sale_items'>;
export type SaleInsert = TablesInsert<'elite_sales'>;
export type SaleItemInsert = TablesInsert<'elite_sale_items'>;
...
export const useSalesData = () => {
  ...
  return useQuery({
    queryKey: ['sales', getTableName('sales')],
    queryFn: async () => {
      const sales = getTableName('sales');
      const sale_items = getTableName('sale_items');
      const spare_parts = getTableName('spare_parts');
...
export const useSalesStats = () => {
  ...
  return useQuery({
    queryKey: ['sales_stats', getTableName('sales')],
    queryFn: async () => {
