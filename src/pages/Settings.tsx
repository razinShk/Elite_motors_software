...
const Settings = () => {
  ...
  const [companyInfo, setCompanyInfo] = useState({
    name: 'Elite Motor and Detailing',
    address: 'Elite Motors & Detailing, Ashoka Marg, Near Ashoka School, Nashik- 422011',
    phone: '8888688448',
    email: 'ELITEMOTORSANDDETAILING5588@gmail.com',
    website: 'www.elitemotoranddetailing.com',
    taxId: 'GST-ELITE-001'
  });
        ...
        <CardContent>
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-4">Go back to the main landing page and showcase of Elite Motor and Detailing.</p>
